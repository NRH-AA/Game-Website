...
class Player(db.Model, UserMixin):
    ...
    experience = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    ...
    direction = db.Column(db.SmallInteger, unsigned=True, nullable=False, default=2)
    ...
    manaspent = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    soul = db.Column(db.Integer, unsigned=True, nullable=False, default=0)
    ...
    lastlogin = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    lastip = db.Column(db.Integer, unsigned=True, nullable=False, default=0)
    ...
    lastlogout = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    ...
    balance = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    offlinetraining_time = db.Column(db.SmallInteger, unsigned=True, nullable=False, default=43200)
    offlinetraining_skill = db.Column(db.Integer, nullable=False, default=-1)
    stamina = db.Column(db.SmallInteger, unsigned=True, nullable=False, default=2520)
    
    skill_fist = db.Column(db.Integer, unsigned=True, nullable=False, default=10)
    skill_fist_tries = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    skill_club = db.Column(db.Integer, unsigned=True, nullable=False, default=10)
    skill_club_tries = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    skill_sword = db.Column(db.Integer, unsigned=True, nullable=False, default=10)
    skill_sword_tries = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    skill_axe = db.Column(db.Integer, unsigned=True, nullable=False, default=10)
    skill_axe_tries = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    skill_dist = db.Column(db.Integer, unsigned=True, nullable=False, default=10)
    skill_dist_tries = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    skill_shielding = db.Column(db.Integer, unsigned=True, nullable=False, default=10)
    skill_shielding_tries = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
    skill_fishing = db.Column(db.Integer, unsigned=True, nullable=False, default=10)
    skill_fishing_tries = db.Column(db.BigInteger, unsigned=True, nullable=False, default=0)
